...
/**
 * This is the ForgetPasswordGenerateEmailRequest class
 *
...
@AllArgsConstructor
@NoArgsConstructor
public class ForgetPasswordGenerateEmailRequest implements RequestEntityInterface {

    @Valid
    @NotNull(message = "Request Body must not be null")
    private ForgetPasswordGenerateEmailRequestBody requestBody;
