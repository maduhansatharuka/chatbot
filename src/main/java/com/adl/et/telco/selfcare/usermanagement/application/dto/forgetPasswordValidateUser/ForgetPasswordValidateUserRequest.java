...
/**
 * This is the ForgetPasswordValidateUserRequest class
 *
...
@AllArgsConstructor
@NoArgsConstructor
public class ForgetPasswordValidateUserRequest implements RequestEntityInterface {

    @Valid
    @NotNull(message = "Request Body must not be null")
    private ForgetPasswordValidateUserRequestBody requestBody;
