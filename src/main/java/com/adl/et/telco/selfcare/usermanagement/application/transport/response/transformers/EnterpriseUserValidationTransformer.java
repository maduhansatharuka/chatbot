...
/**
 * This is the Class for EnterpriseUserValidationTransformer class
 *
 ...
 */
@Component
public class EnterpriseUserValidationTransformer implements ResponseEntityInterface {

    public Map transform(Object entity) {

        EnterpriseUserValidationResponse response = (EnterpriseUserValidationResponse) entity;
